...
class HashtagRecipesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const int hashtagRecipeLimit = 10;
    DocumentSnapshot? _lastDocument;
    bool _hasMoreData = true;

    _getHashtagRecipes() async {
      final CollectionReference _hashtagRecipeCollectionReference = collectionsRef
      ...
      var pageHashtagRecipeQuery = _hashtagRecipeCollectionReference
          ...
          .limit(hashtagRecipeLimit);

      if (_lastDocument != null) {
        pageHashtagRecipeQuery = pageHashtagRecipeQuery.startAfterDocument(_lastDocument!);
      }
      ...
      pageHashtagRecipeQuery.snapshots().listen(
          ...
          if (snapshot.docs.isNotEmpty) {
            ...
            _hasMoreData = generalHashtagRecipes.length == hashtagRecipeLimit;
          }
        },
      );
    }
